...
// configuration step. It creates a namespace called `FtxUiTemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", FtxUiTemplate::cmake::project_name, FtxUiTemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", FtxUiTemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
